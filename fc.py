...
face_recognition_dict_n = {"ben_afflek": "ben_afflek ", 
                      "elton_jhon": "elton_john",
...
def draw_test(name, pred, im):
    faces = face_recognition_dict[str(pred)]
    BLACK = [0,0,0]
...
for i in range(0,10):
    input_im = getRandomImage("C:/Users/acer/Desktop/Mlops/Deep_learning/val/")
